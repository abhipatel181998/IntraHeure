		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-lg-3">
						<div class="dash-widget clearfix card-box">
							<span class="dash-widget-icon"><i class="la la-user"
								aria-hidden="true"></i></span>
							<div class="dash-widget-info">
								<h3>${sessionScope.hrlist}</h3>
								<span>Hr</span>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6 col-lg-3">
						<div class="dash-widget clearfix card-box">
							<span class="dash-widget-icon"><i class="la la-suitcase"></i></span>
							<div class="dash-widget-info">
					...
					<div class="col-md-6 col-sm-6 col-lg-3">
						<div class="dash-widget clearfix card-box">
							<span class="dash-widget-icon"><i
								class="la la-calendar-check-o" aria-hidden="true"></i></span>
							<div class="dash-widget-info">
					...
					<div class="col-md-6 col-sm-6 col-lg-3">
						<div class="dash-widget clearfix card-box">
							<span class="dash-widget-icon"><i class="la  la-sign-out"></i></span>
							<div class="dash-widget-info">
					...
					<div class="col-md-6 col-sm-6 col-lg-3">
						<div class="dash-widget clearfix card-box">
							...
							<div class="dash-widget-info">
								<h3>${sessionScope.feedbacklist}</h3>
								<span>Feedbacks</span>
							</div>
						</div>
					</div>
