			...
			<div class="content container-fluid">
				<div class="row">
					...
					<div class="col-sm-4 text-right m-b-30">
						<a class="btn btn-primary rounded" href="editProfile"><i
							class="fa fa-plus"></i> Edit Profile</a>
					</div>
				</div>
				<div class="card-box">
					<div class="row">
									...
									<div class="row">
										<div class="col-md-5">
											<div class="profile-info-left">
												<h3 class="user-name m-t-0 m-b-0 text-capitalize">${data.firstName }
													${data.lastName }</h3>
										...
										<div class="col-md-7">
											<ul class="personal-info">
												...
												<li><span class="title">Birth Date:</span> <span
													class="text">${data.birthDate }</span></li>
												<li><span class="title">Address:</span> <span
													class="text">${data.residentialAddress }</span></li>
												<li><span class="title">City:</span> <span class="text">${data.cityVo.cityName }</span></li>
