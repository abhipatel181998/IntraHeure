							...
							<table class="table table-striped custom-table m-b-0"
								...
								<tbody>
									<c:forEach items="${employeeData }" var="data">
										<c:if
											test="${sessionScope.departmentId eq data.departmentVo.departmentId }">
											<tr>
												...
												<td><a
													href="approveRegRequest?loginVo.loginId=${data.loginVo.loginId}"
													class="btn btn-success">Approve</a> &nbsp; <a
													href="rejectRegRequest?loginVo.loginId=${data.loginVo.loginId}"
